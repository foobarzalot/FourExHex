...
public class HexTile
{
    ...
    /// <summary>
    /// The tile's mutually-exclusive terrain feature: plain, gold,
    ...
    /// <see cref="IsMountain"/></b>: setting this <c>true</c> sets
    ...
    /// <summary>
    /// A mountain tile: defensive terrain that radiates tower-strength defense
    /// (<see cref="DefenseRules.MountainDefense"/>) to same-owner neighbors. A
    /// convenience view over <see cref="Feature"/>, mutually exclusive with
    /// <see cref="IsGold"/>: setting this <c>true</c> sets <see cref="Feature"/>
    /// to <see cref="TerrainFeature.Mountain"/>, which clears any gold. Trees and
    /// graves coexist with mountains. No income of its own. Authored via the map
    /// editor and scattered as mountain ranges by <c>MapGenerator</c> when its
    /// mountain density is &gt; 0.
    /// </summary>
