...
public class ReplayPlaybackTests
{
    ...
    private class Fixture
    {
        ...
        public void AssertStateMatches(GameStateSnapshot reference)
        {
            ...
            foreach ((HexCoord coord, PlayerId color, HexOccupant? occupant, bool _, bool _) in reference.EnumerateTiles())
            {
    ...
    public void Replay_Instant_RedrawsOncePerTurn_NotPerCapture()
    {
        ...
        foreach ((HexCoord coord, PlayerId color, HexOccupant? occ, bool _, bool _) in live.EnumerateTiles())
