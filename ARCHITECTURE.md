...
**No taint bit.** The `#if DEBUG` CheatMenu has no state-mutating entry, so a "run was assisted" flag would be unreachable code. It belongs on the day the first such cheat lands.
